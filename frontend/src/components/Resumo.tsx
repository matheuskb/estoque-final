...
export function Resumo({ dados, totalValor }: Props) {
          ...
          return (
            <div key={d.categoria}>
              <div className="flex items-baseline justify-between gap-3 mb-1.5">
                <span
                  className="text-xs text-tx-secondary truncate"
                  title={d.categoria}
                >
                  {d.categoria}
                </span>
                <div className="flex items-center gap-4 shrink-0">
                  ...
                  <span className="font-mono text-xs font-medium text-tx-primary">
                    {brl(d.valor)}
                  </span>
                  <span className="font-mono text-2xs text-tx-muted w-8 text-right">
                    {pct.toFixed(0)}%
                  </span>
                </div>
              </div>
